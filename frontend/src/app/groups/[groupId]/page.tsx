      ...
      <div className="flex">
        ...
        <main className="w-3/4 p-8">
          ...
          <div className="flex items-start space-x-6">
            {/* <!-- Profile Info --> */}
            <Group fname={profile.fname} lname={profile.lname} avatarUrl={profile.avatarUrl} bio={profile.bio} nickname={profile.nickname} session_user={sessionUser} u_id={u_id} privacy={profile.privacy} />
